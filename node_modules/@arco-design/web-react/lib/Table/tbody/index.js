...
function TBody(props) {
    ...
    if (virtualized) {
        return data.length > 0 ? (react_1.default.createElement(VirtualList_1.default, __assign({ data: data, height: scrollStyleY.maxHeight, isStaticItemHeight: false, 
            ...
            }, itemKey: getRowKey }, virtualListProps), renderDataRecord)) : (react_1.default.createElement("div", { className: prefixCls + "-body", ref: saveRef },
            react_1.default.createElement("table", null,
                react_1.default.createElement("tbody", null, noDataTr))));
    }
    return (react_1.default.createElement(ComponentTbody, { ref: saveRef }, data.length > 0 ? data.map(renderDataRecord) : noDataTr));
}
