                ...
                if (invisibleTagCount > 0) {
                    ...
                    if (showPopover) {
                        var popoverTags = usedValue
                            ...
                            return renderTag ? (renderTag(__assign(__assign({}, tagProps), { onClose: function () { } }), tag.index, tagsToShow.concat(itemProps_1))) : (react_1.default.createElement(Tag_1.default, __assign({}, tagProps, { key: tagProps.value, className: tagPrefixCls + "-tag", onClose: function (e) { return eventHandlers.onRemove(tagProps.value, tag.index, e); } }), tagProps.label));
                        });
                        itemProps_1.label = (react_1.default.createElement(Popover_1.default, { content: !!popoverTags.length && react_1.default.createElement(react_1.default.Fragment, null, popoverTags) }, itemProps_1.label));
                    }
                    return itemProps_1;
                }
            }
